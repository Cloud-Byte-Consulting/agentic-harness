...
Recon and Judge are read-only. Tier-2/3 writes require a /mutation-gate ALLOW, not just an approval click. Default ESCALATE on unclear ownership or low gate confidence. Grande (Cordillera) and TRAPI prod always require explicit authorization.
