# PR bundle — Team-alpha skills (staged)

These 15 Kubernetes / cloud-native content skills are **staged** in agent-coordination
for review. They are NOT yet written into the production Team-alpha repo.
...
```
../team-alpha-agent-system/.claude/skills/<skill-name>/
```
...
- Governance mapping: `contracts/skill-routing.yaml` → `team-alpha-router`.
